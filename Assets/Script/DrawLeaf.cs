...
{
    public Mesh ShapeMesh;//ÐÎ×´µÄMesh
    public Mesh LeafMesh;//Ê÷Ò¶µÄMesh
    public List<Material> mats = new List<Material>();
    [Range(0.1f,1f)]
    public float LeafDenesity = 1;//Ê÷Ò¶µÄÃÜ¶È
    [Range(0.1f, 2f)]
    public float LeafSize = 1;//Ê÷Ò¶µÄ³ß´ç
    [Range(0f, 1f)]
    public float LeafOffset = 0;//Ê÷Ò¶µÄÆ«ÒÆ
    [Range(0f,1f)]
    public float LightOffset = 0;//¹âÕÕÆ«ÒÆ
    [Range(0f, 1f)]
    public float LifhtOffsetDenesity = 0;//¹âÕÕÆ«ÒÆµÄ¼¸ÂÊ
